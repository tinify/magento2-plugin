...
CREATE TABLE `admin_system_messages` (
  ...
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Create date',
...
INSERT INTO `admin_system_messages` VALUES ('da332d712f3215b9b94bfa268c398323',2,'2016-01-09 22:05:15');
...
CREATE TABLE `admin_user` (
  ...
  `modified` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT 'User Modified Time',
...
INSERT INTO `admin_user` VALUES (1,'admin','admin','admin@example.com','admin','cf617f45073f8b72e6e35756ebbe8b94986554614382348594d0b4ea20b48f0e:m8xZSgJ8Te0YqS1A8BrKrPew7UO0GFOA:1','2016-01-09 22:04:48','2016-01-09 22:05:13','2016-01-09 22:05:13',1,0,1,'N;',NULL,NULL,'en_US',0,NULL,NULL);
...
INSERT INTO `catalog_category_entity` VALUES (1,0,0,'2016-01-09 22:04:46','2016-01-09 22:04:46','1',0,0,1),(2,3,1,'2016-01-09 22:04:46','2016-01-09 22:04:46','1/2',1,1,0);
...
CREATE TABLE `cms_block` (
  ...
  `creation_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Block Creation Time',
  `update_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT 'Block Modification Time',
...
CREATE TABLE `cms_page` (
  ...
  `creation_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Page Creation Time',
  `update_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT 'Page Modification Time',
...
INSERT INTO `core_config_data` VALUES (1,'default',0,'web/seo/use_rewrites','1'),(2,'default',0,'web/unsecure/base_url','http://localhost:3000/'),(3,'default',0,'web/secure/base_url','https://localhost:3000/'),(4,'default',0,'general/locale/code','en_GB'),(5,'default',0,'web/secure/use_in_frontend',NULL),(6,'default',0,'web/secure/use_in_adminhtml',NULL),(7,'default',0,'general/locale/timezone','UTC'),(8,'default',0,'currency/options/base','EUR'),(9,'default',0,'currency/options/default','EUR'),(10,'default',0,'currency/options/allow','EUR'),(11,'default',0,'general/region/display_all','1'),(12,'default',0,'general/region/state_required','AT,BR,CA,CH,DE,EE,ES,FI,FR,LT,LV,RO,US'),(13,'default',0,'catalog/category/root_id',NULL);
...
CREATE TABLE `customer_visitor` (
  ...
  `last_visit_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT 'Last Visit Time',
...
CREATE TABLE `downloadable_link_purchased` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT 'Date of modification',
...
CREATE TABLE `email_template` (
  ...
  `added_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Date of Template Creation',
  `modified_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT 'Date of Template Modification',
...
CREATE TABLE `flag` (
  ...
  `last_update` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT 'Date of Last Flag Update',
  PRIMARY KEY (`flag_id`),
...
CREATE TABLE `import_history` (
  ...
  `started_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Started at',
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'User ID',
...
INSERT INTO `indexer_state` VALUES (1,'customer_grid','valid','2016-01-09 22:04:45','9b4506442a512a649dde7c6f25924134'),(2,'catalog_category_product','invalid','2016-01-09 22:04:45','86038392fe878acd22d5650a99b4f9b3'),(3,'catalog_product_category','invalid','2016-01-09 22:04:45','8fd6f9a1ec8741ce1c7984b549915e8e'),(4,'catalog_product_price','invalid','2016-01-09 22:04:45','0dce29088c0563479f66b2a70ebf152b'),(5,'catalog_product_attribute','invalid','2016-01-09 22:04:45','5ee6fe2540126b9b2c90c53fe25c4d9a'),(6,'cataloginventory_stock','invalid','2016-01-09 22:04:45','030021373629a9e2b3b8ffcc92be9483'),(7,'catalogrule_rule','invalid','2016-01-09 22:04:45','63676f01f658a0964f150347a6596a0a'),(8,'catalogrule_product','invalid','2016-01-09 22:04:45','f9512548ab97beef43ea393d4a6dc545'),(9,'catalogsearch_fulltext','valid','2016-01-09 22:04:47','a959fbd517e02dc6c79ef261cc983c97');
...
CREATE TABLE `oauth_token` (
  ...
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Token creation timestamp',
  PRIMARY KEY (`entity_id`),
...
CREATE TABLE `sales_shipment_grid` (
  ...
  `order_id` int(10) unsigned NOT NULL COMMENT 'Order Id',
  `order_created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT 'Order Increment Id',
  `customer_name` varchar(128) NOT NULL COMMENT 'Customer Name',
  `total_qty` decimal(12,4) DEFAULT NULL COMMENT 'Total Qty',
  `shipment_status` int(11) DEFAULT NULL COMMENT 'Shipment Status',
...
INSERT INTO `session` VALUES ('2utvimvimk7pt0f4lrhi2a8hr3',1452459042,''),('9gur452gs18d3u9lb5uqtia9d5',1452377837,''),('t3fn6lofumsqs2iie5agkkabh4',1452459042,'');
...
INSERT INTO `theme` VALUES (1,NULL,'Magento/backend','Magento 2 backend',NULL,0,'adminhtml',0,'Magento/backend'),(2,NULL,'Magento/blank','Magento Blank','preview_image_569183fc97af5.jpeg',0,'frontend',0,'Magento/blank'),(3,2,'Magento/luma','Magento Luma','preview_image_569183fca615d.jpeg',0,'frontend',0,'Magento/luma');
...
-- Dump completed on 2016-01-10 21:59:49
